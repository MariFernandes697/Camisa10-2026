            ...
            <div class="carousel-inner">
                ...
                ?>
                    <div class="carousel-item <?php echo $classeActive; ?>">
                        <img src="<?php echo htmlspecialchars($promocao['imgPromocao']) ?>" class="d-block w-100" alt="Banner Promocional">
                    </div>
                <?php 
                    $primeiroItem = false;
                endwhile; 
        ...
        ?>
            <article class="product-card" style="cursor: pointer;">
                <figure class="card-figure">
                    <img src="<?php echo htmlspecialchars($cat['imgCategoria']); ?>" alt="Categoria <?php echo htmlspecialchars($cat['tituloCategoria']); ?>" class="card-image">
    ...
    <div class="todos-os-produtos">
        <div class="topo">
            ...
            <div class="caixa-filtro">
                    ...
                    <button id="limparSeletor" class="btnLimparSeletor" title="Limpar filtro"><i class="bi bi-x"></i></button>
                </div>
        </div>
        <!-- Produtos -->
<!-- Produtos -->
        ...
        <?php while($produto = mysqli_fetch_assoc($resultado)): ?>
            ...
            <div class="card">
                <div class="img-produto">
                    <img src="<?php echo htmlspecialchars($produto['imgProduto']) ?>" alt="<?php echo htmlspecialchars($produto['tituloProduto']) ?>">
                </div>
                ...
                <button class="btn-card"><a href="verProduto.php?idProduto=<?php echo $produto['idProduto']; ?>">Ver mais</a></button>
            </div>
        <?php endwhile; ?>
    <?php else: ?>
