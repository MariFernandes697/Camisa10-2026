        ...
        <div class="card shadow-sm p-4">
            ...
            <form action="actionCrud.php" method="POST" class="was-validated" enctype="multipart/form-data">
                ...
                <div class="form-floating mt-3 mb-3">
                    <input type="file" class="form-control" id="imgProduto" placeholder="Imagem do Produto" name="imgProduto">
                ...
                <div class="form-floating mt-3 mb-3">
                    <input type="text" class="form-control" id="tituloProduto" placeholder="Titulo do Produto" name="tituloProduto">
                ...
                <div class="form-floating mt-3 mb-3">
                    <input type="text" class="form-control" id="descricaoProduto" placeholder="Descricao do Produto" name="descricaoProduto">
                ...
                <div class="form-floating mt-3 mb-3">
                    <input type="text" class="form-control" id="precoProduto" placeholder="Valor Produto" name="precoProduto">
                    <label for="precoProduto">Valor do Produto</label>
                    <div class="valid-feedback"></div>
                    <div class="invalid-feedback"></div>
                </div>
                
                <button name="acao" value="cadastrarProduto" type="submit" class="btn btn-success">Cadastrar Produto</button>
            </form>
        </div>
    </section>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo $linha['imgProduto']; ?>" alt="Imagem da Produto" class="img-thumbnail" style="width: 50px; height: 50px; object-fit: cover;">
                                    </td>
