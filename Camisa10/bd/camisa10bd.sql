...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/06/2026 às 14:12
...
(6, 'Raquete Carbon Strike', 9, 459.00, 'Construção em carbono: leveza e potência para smash.', 'assets/produtos/prod4.png'),
...
(9, 'Tênis Esportivo FlexRun', 3, 249.90, 'Solado com amortecimento dinâmico.', 'assets/produtos/prod23.png'),
(10, 'Kit Tênis de Mesa Starter', 6, 89.90, '2 raquetes + 3 bolas para iniciantes.', 'assets/produtos/prod24.png'),
(12, 'Capacete AeroRoad', 7, 229.90, 'Design aerodinâmico e ventilação tripla.', 'assets/produtos/prod17.png'),
(13, 'Joelheira ProShield', 4, 59.90, 'Compressão firme e material respirável.', 'assets/produtos/prod19.png'),
...
--
ALTER TABLE `produtos`
  MODIFY `idProduto` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
